...
$(document).ready(function() {
    ...
    if(luntan) {
        $('#luntan').attr("src", "../image/linpai/luntanlin@2x.png");
    }
    if(zhaohuan) {
        $('#zhaohuan').attr("src", "../image/linpai/zhaohuanlin@2x.png");
    }
    if(qiandao) {
        $('#qiandao').attr("src", "../image/linpai/qiandaolin@2x.png");
    }
    if(quannei) {
        $('#quannei').attr("src", "../image/linpai/quanneilin@2x.png");
    }
...
var sm = (function(undefined){
    ...
    function tanchuang(value) {
        ...
        if(prize == 'luntanling' || prize == 'qiandaoling' || prize == 'quanneiling' || 'zhaohuanling')
        {}
